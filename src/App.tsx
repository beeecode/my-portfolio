        ...
        >
          ...
          <div className="flex-1 flex flex-col md:grid md:grid-cols-12 gap-8 md:gap-12 relative z-10">
            <div className="md:col-span-7 lg:col-span-8 flex flex-col">
              ...
              >
                Frontend Developer with over 2 years of experience specializing in responsive, pixel-accurate interfaces and seamless REST API integrations. Building scalable platforms with React, Next.js, and Tailwind CSS optimized for strong Core Web Vitals.
              </motion.p>
              ...
              <div className="technical-border bg-white/[0.02] p-6 rounded-2xl md:bg-transparent md:border-0 md:p-0">
                ...
                <div className="space-y-5">
                  {[
                    ...
                    { label: "UI / Layout", value: "Tailwind / CSS Grid" },
                    { label: "Integration", value: "REST APIs / Data" },
