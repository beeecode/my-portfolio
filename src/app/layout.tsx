  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        */}
        <script src="https://manageull-backend.onrender.com/runtime/script" data-manageull-key="mng_site_4qfjsfbTPpi96i6FNk9e-OzZbt4-vgjZzTIKLuoaajE" crossOrigin="anonymous" async></script>
        <link
          rel="stylesheet"
