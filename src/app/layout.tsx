...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
<script src="https://radical-tool-common-adrian.trycloudflare.com/runtime/script" data-manageull-key="mng_site_K_eQj046y8cf0LzwBAesCINx8sSQdE4rnxBstZ1L-Zw" crossOrigin="anonymous" async></script>
